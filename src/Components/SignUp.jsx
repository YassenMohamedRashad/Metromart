      ...
      <div className="row signup align-items-center justify-content-center d-flex">
        ...
        <div className="col justify-content-center d-flex">
          <div className="mt-5 mb-5">
            ...
            <form className="form signup-form" method="post" onSubmit={handleSubmit}>
              <h5>Enter your Details Below</h5>
              {/* Name input */}

              <input type="text" name="username" className="mt-5 name-input inputs" value={formData.username} required onChange={handleChange} />
              <label className="name-label">Name</label>
              <br />

              {/* Email input */}
              <input type="text" name="email" value={formData.email} className="mt-5 email-input inputs" required onChange={handleChange} />
              <label className="email-label">Email</label>
			  <br />
			  <div className="email-error">
              	<small className="text-danger mt-2 ">{formErrors.email}</small>
			  </div>
			  <br />


              {/* Password input */}
              <input type="password" name="password" className="mt-4 pass-input inputs" required value={formData.password} onChange={handleChange} />
              ...
              {/* Phone number input */}
              <input type="tel" name="phoneNumber" className="mt-5 phonenumber-input inputs" required value={formData.phoneNumber} onChange={handleChange} />
              <label className="phonenumber-label">Phone Number</label>
			  <br />
			  <div className="phoneNumber-error">
				<small className="text-danger mt-2">{formErrors.phoneNumber}</small>
			  </div>
			  <br />


              {/* Age input */}
              <input type="number" name="age" className="mt-4 age-input inputs" required value={formData.age} onChange={handleChange} />
              <label className="age-label">Age</label>
			  <br />
			  <div className="age-error">
				<small className="text-danger mt-2 d-block">{formErrors.age}</small>
			  </div>
			  <br />
              ...
              <div className="d-flex">
                <div className="form-check mt-2 me-4">
                  <input className="form-check-input male-input shadow" type="radio" name="gender" value={"male"} checked={MaleChecked} onChange={handleChange} onClick={() => { setMaleChecked(true); setFemaleChecked(false);}}/>
                  <label className="form-check-label male-label">Male</label>
                </div>
                <div className="form-check mt-2 ">
                  <input className="form-check-input female-input shadow" type="radio" name="gender" value={"female"} checked={FemaleChecked} onChange={handleChange} onClick={() => { setMaleChecked(false); setFemaleChecked(true);}}/>
              ...
              <button className="btn btn-danger mt-4 w-100" type="submit">
                Create Account
              </button>
              <br />
            </form>
