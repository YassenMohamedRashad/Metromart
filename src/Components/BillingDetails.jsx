            ...
            <div className="row">
                ...
                <div className="col-md-6 col-lg-6 col-sm-12 text-center">
                    ...
                    <div className="row w">
                        ...
                        <div className="col-md-3 m-auto col-sm-4">$50</div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-3 m-auto">$50</div>
                        <br />
                        <br />
                        <br />
                        <hr />
                    ...
                    <div className="row">
                        ...
                        <div className="col-3 m-auto">Free</div>
                        <br />
                        <br />
                        <br />
                        <hr />
                    ...
                    <div className="row">
                        ...
                        <div className="col-3 m-auto">$5000</div>
                        <br />
                        <br />
                        <br />
                        <hr />
                    ...
                    <form method="post" className="row mt-3">
                        <input
                            className="w-50 form-control col-6"
                            placeholder="Coupon Code"
                            type="text"
                        />
                        <button className="btn btn-danger col-4 text-light m-auto">
                            Apply Coupon
                        </button>
                    </form>

                    <div className="row">
                        <button className="btn btn-danger text-light mt-4 w-25">
                            Place Order
                        </button>
                    </div>
                </div>
