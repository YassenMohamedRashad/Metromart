              ...
              <div className="row">
                <div className="col-4">
                  <img
                    ...
                    src={JSON.parse(product.product_data.image_path)[0]}
                    alt=""
                  />
                </div>
                <div className="col-8">
                  ...
                  <div className="d-flex">
                    ...
                    <h5 className="ms-4">
                      <span className="text-black">
                        Total Price:{" "}
                        {product.product_data.price * product.quantity}$
                      </span>
                    </h5>
                  </div>
                  ...
                  <div className="d-flex mt-3">
                    ...
                    <button
                      ...
                      onClick={(e) =>
                        deleteProductFromCart(e, product.product_data.id)
                      }
                    >
                      Remove from Cart
                    </button>
        ...
        {Products.length != 0 ? (
          <div className="mt-5">
            <div className="d-flex justify-content-between">
              <h4>
                Total Price:{" "}
                <span className="text-danger">{calculateTotalPrice()}$</span>
              </h4>
