    ...
    return (
        <div className="col-8 col-sm-6 col-md-4 col-lg-3 .col-xl-2">
            <div class="card border-0 ">
                ...
                {/* Heart Icon */ }
                <button className="btn position-absolute translate-middle badge rounded-pill bg-white heart_icon_container " style={ { top: 30, right: -5 } }><svg width="22" height="18" viewBox="0 0 24 21" fill="none" className='heart_icon ' xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="card-body ps-0">
                    ...
                    <div className='d-flex rating-starts'>
                        ...
                        <img style={ { width: 20 } } src={ unchecked_star_icon } alt="alt" />
                        <img style={ { width: 20 } } src={ unchecked_star_icon } alt="alt" />
                        <h6 className='text-secondary ms-2 product-card-reviews'>({ item.stock })</h6>
                    </div>
                </div>
            </div>
        </div>
