                            ...
                            <div className="col-md-4">
                                <form style={{ width: "26rem" }}>
                                    ...
                                    <div
                                        ...
                                        <label className="form-label name-contact-label">
                                            Name
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div
                                        ...
                                        <input
                                            type="email"
                                            className="form-control email-contact-input"
                                        />
                                    </div>
                                    {/* Message input */}
                                    <div
                                        data-mdb-input-init
                                        className="form-outline mb-4">
                                        <label className="form-label msg-contact-label">
                                            Message
                                        </label>
                                        <textarea
                                            className="form-control msg-contact-label"
                                            rows={4}
                                        />
                                    </div>
                                    {/* Checkbox */}
