...
function Shop() {
    return (
        <div className="container">
            ...
            {/* category word */}
            <div className="row">
                <h4 className="text-danger mt-2 red-label">categories</h4>
            </div><br />
            ...
            {/* cards of category */}
            <div className="row row-cols-2 row-cols-sm-3 row-cols-lg-5 p-3">
                {/* phone category */ }
                <div className="col">
            ...
            {/* This Month word */}
            <div className="row">
                <h4 className="text-danger mt-2 red-label">This Month</h4>
            </div><br />
