		...
		<>
			...
			<div className="container-fluid">
				<div className="row wishlist-row">
					<h4 className="col-xxl-10 col-xl-10 col-lg-9 col-md-8 col">
						Wishlist (4)
					</h4>
					<button class="col btn btn-outline-dark btn-lg">
						Move All To Bag
					</button>
				</div>
				{/* wishlist row */}
					...
					<div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
						...
						<div className="card">
							<div>
								{/* sale button */}
								<div>
									<button class="sale btn btn-danger align-self-end">
										-35%
									</button>
								</div>
								{/* trash icon */}
				...
				<div className="row foryou-row">
					<h4 className="col-xxl-10 col-xl-10 col-lg-9 col-md-8 col">
						<span class="bg-danger space">&nbsp;&nbsp;</span> Just
						For You
					</h4>
					<button class="col btn btn-outline-dark btn-lg">
						See All
					...
					<div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
						...
						<div className="card">
							<div>
								...
								<div>
									<button
										class="sale btn align-self-end text-light"
										style={{
