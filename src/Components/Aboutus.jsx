            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-sm-6 col-md-4">
                        <a
                            className="a"
                            href="https://eg.linkedin.com/in/ahmed-ali-othman-5b503324a">
                    ...
                    <div className="col-sm-6 col-md-4">
                        <a
                            className="a"
                            href="https://www.linkedin.com/in/yassenmohamedrashad?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
                            <div className="team-item ho">
                    ...
                    <div className="col-sm-6 col-md-4">
                        <a
                            className="a"
                            href="https://www.linkedin.com/in/yousef-ahmed-fouad-abdullatif-95b7ba288/">
                            <div className="team-item ho">
                ...
                <div className="row">
                    ...
                    <div className="col-sm-6 col-md-4">
                        <a
                            className="a"
                            href="http://www.linkedin.com/in/zeyad-hyman-227746297">
                            <div className="team-item ho">
                    ...
                    <div className="col-sm-6 col-md-4">
                        <a
                            className="a"
                            href="https://www.linkedin.com/in/basmala-magdy-993869230">
                            <div className="team-item ho">
                                <img
                                    className="team-img"
                                    src={Basmala}
