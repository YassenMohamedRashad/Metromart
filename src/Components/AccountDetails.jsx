            ...
            <div className="container mt-5 mb-5" style={ { marginTop: 75 } }>
                ...
                <div className="row">
                    ...
                    <div className='col-lg-8 mt-lg-0 mt-5'>
                        <form method='post' class="shadow-sm rounded">
                            <h4 className=' text-danger '>Edit Your Profile</h4>
                            <div className="d-flex justify-content-between mt-3">
                                <div>
                                    <label htmlFor="FirstName" className='fw-bold'>First Name</label>
                                    <input type="text" name="firstname" className='form-control bg-light text-secondary border-0 mt-2' placeholder='first name' onChange={ changeFirstname } />
                                </div>
                                <div>
                                    <label htmlFor="LastName" className='fw-bold'>Last Name</label>
                                    <input type="text" name="lastname" className='form-control bg-light text-secondary border-0 mt-2' placeholder='second name' onChange={ changeLastname } />
                                </div>
                            </div>
                            <div className="d-flex justify-content-between mt-3">
                                <div>
                                    <label htmlFor="Email" className='fw-bold'>Email</label>
                                    <input type="email" placeholder='Email' name="email" className='form-control bg-light text-secondary border-0 mt-2' />
                                </div>
                                <div>
                                    <label htmlFor="Adress" className='fw-bold'>Address</label>
                                    <input type="text" placeholder='Address' name="address" className='form-control bg-light text-secondary border-0 mt-2' />
                                </div>
                            </div>
